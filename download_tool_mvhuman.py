...
import urllib, requests, quickxorhash
...
# urls = {
#     "MVHumanNet_0_samples" : "https://cuhko365.sharepoint.com/:f:/s/SSE_GAP-Lab/Eh25k6jjh0NIvxLLBKP7U4EBFcuNrYy3Gf34ZfEjdFDgGQ?e=36Pe2X", }

def parse_args():
    """
    Args:
        download_folder: path to store download data.
    ...
    """
    parse = argparse.ArgumentParser(description='Download MVHumanNet data')
    parse.add_argument('--data_name',  type=str, required=True, help='folder name, e.g. MVHumanNet_24_Part_01')
    parse.add_argument('--url', type=str, required=True, help='download link')
    parse.add_argument('--download_folder', type=str, required=True, help='path to store download data')
